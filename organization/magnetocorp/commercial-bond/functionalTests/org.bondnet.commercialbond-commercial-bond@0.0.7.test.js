...
describe('org.bondnet.commercialbond-commercial-bond@0.0.8' , () => {
    ...
    it('getBond', async () => {
        ...
        console.log(`${bond.issuer} commercial bond : ${bond.bondNumber} successfully retrieved with owner ${bond.owner} at rate ${bond.couponRate}`);
    ...
    it('issue', async () => {
        ...
        const CommercialBond = require('../lib/bond.js');
        let bond = CommercialBond.fromBuffer(response);
        console.log(`${bond.issuer} commercial bond : ${bond.bondNumber} successfully issued for value ${bond.faceValue} at rate ${bond.couponRate}`);
        console.log('Transaction complete.'); 
    }).timeout(10000);
    ...
    it('buy', async () => {
        ...
        const CommercialBond = require('../lib/bond.js');
        let bond = CommercialBond.fromBuffer(response);
        console.log(`${bond.issuer} commercial bond : ${bond.bondNumber} successfully purchased by ${bond.owner}`);
        console.log('Transaction complete.');
    ...
    it('redeem', async () => {
        ...
        const CommercialBond = require('../lib/bond.js');
        let bond = CommercialBond.fromBuffer(response);
        console.log(`${bond.issuer} commercial bond : ${bond.bondNumber} successfully redeemed with ${bond.owner}`);
        console.log('Transaction complete.');
